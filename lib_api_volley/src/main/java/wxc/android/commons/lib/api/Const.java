...
public final class Const {
    ...
    private static final boolean API_TEST = true; // TODO: This is import!!!

    public static final int APP_ID = 1;
    public static final String APP_KEY = "1d92ccf0d57c9480bfebf06f52c9e9a5";

    private static final String HOST = "http://api.android.wxc";
    private static final String HOST_SANDBOX = "http://test.api.android.wxc";
